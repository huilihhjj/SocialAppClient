...
export const getUserData = () => (dispatch) => {
    ...
    axios.get('/user').then(res => {
        console.log('----userActions:::getUserData:::', 'res.data: ', res.data);
        dispatch({
            type: SET_USER,
            payload: res.data
        })
...
export const markNotificationsRead = (notificationIds) => dispatch => {
    console.log('----userActions:::markNotificationsRead:::', 'notificationIds: ', notificationIds);
    axios.post('/notifications', notificationIds).then(res => {
        console.log('----userActions:::markNotificationsRead:::', 'res: ', res);
        dispatch({
